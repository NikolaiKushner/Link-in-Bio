...
export default function Select({
  ...
  // Base styles
  const baseStyles =
    "transition-all duration-200 focus:outline-none appearance-none bg-no-repeat";

  // Variant styles (matching Input filled style)
  const variantStyles =
    "border-0 bg-gray-50 focus:ring-2 focus:ring-gray-900 px-4 py-3 rounded-xl pr-10";
  ...
  const combinedClassName =
    `${baseStyles} ${variantStyles} ${errorStyles} ${widthStyles} ${arrowBg} ${className}`
      .trim();
